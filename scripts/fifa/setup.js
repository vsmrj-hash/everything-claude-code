...
async function main() {
  ...
  if (!process.env.YOUTUBE_CLIENT_ID || !process.env.YOUTUBE_CLIENT_SECRET) {
    ...
    console.error('  6. Copy the Client ID and Client Secret into scripts/fifa/.env\n');
    process.exit(1);
  }
  ...
  console.log('   Token saved to scripts/fifa/data/youtube-token.json');
  console.log('\n   Run the pipeline now:');
  console.log('   node scripts/fifa/index.js\n');
}
